...
class StoryView extends Component {
    ...
    componentWillReceiveProps(nextProps) {
      console.log("STORYVIEW component receive props")
        if (
            ...
            console.log("STORYVIEW component receive props 2: USER ", user)
            console.log("STORYVIEW component receive props 2: WORLD ", world)
    ...
    _loadStories = (user, stories) => {
            ...
            console.log("STORYVIEW loadstories:  ", stories)
    ...
    refreshUserTask = () => {
      console.log("STORYVIEW refreshusertask:  ", this.props.world.groups)
    ...
    componentDidMount() {
      console.log("STORYVIEW componentdidmount:  ", this.props.user)
        if (this.props.user) {
