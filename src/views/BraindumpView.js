...
export default class BraindumpView extends BaseComponent {
  ...
  saveBrainDump(data) {
    ...
    instance
      ...
      console.log ("BRAINDUMP: pending users: ", checkUnlockAllParties(this.state.group))
      console.log ("BRAINDUMP: next sequence: ", checkUnlockNextSequence(this.state.group))
